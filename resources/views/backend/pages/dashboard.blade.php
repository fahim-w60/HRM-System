            ...
            <div class="row layout-top-spacing">
                    ...
                    <div class="widget widget-six">
                        ...
                        <div class="w-chart">
                            <div class="w-chart-section">
                                <div class="w-detail">
                                    <p class="w-title">Full Time</p>
                                    <p class="w-stats">964</p>
                                </div>
                    ...
                    <div class="widget widget-card-four">
                        <div class="widget-content">
                            ...
                            <div class="w-content">
                                ...
                                <div class="w-info">
                                    <p class="value"> 25 <span>Various Department</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg></p>
                                </div>
                            ...
                            <div class="account-box">
                                <div class="info">
                                    ...
                                    <div class="inv-balance-info">
                                        <p class="inv-balance">10,0000 BDT</p>
                ...
                <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-chart-three">
                        <div class="widget-heading">
                            <div class="">
                                <h5 class="">Employee Attendance Ratio</h5>
                            </div>
